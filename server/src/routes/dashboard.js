...
router.post('/feedback/:id/add-variations', async (req, res) => {
  try {
    const { id } = req.params;
    const { variations } = req.body; // Array von { text, editedText (optional) }
    ...
    console.log(`✅ ${addedVariations.length} Variationen zu Training-Daten hinzugefügt (Feedback-ID: ${id}, Situation: ${detectedSituation})`);
