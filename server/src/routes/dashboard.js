...
router.post('/feedback', async (req, res) => {
  try {
    ...
    // 🚨 NEU: Bei ASA-Fällen: customerMessage und lastModeratorMessage sind irrelevant
  ...
  try {
    ...
    if (status === 'good') {
      ...
      trainingData.conversations.push({
        ...
        situation: detectedSituation, // Automatisch erkannte Situation (oder "Generische ASA (Neukunde)" bei ASA)
  ...
  try {
    ...
    variations.forEach((variation, index) => {
      ...
      const newConversation = {
        ...
        situation: selectedSituation, // Verwende ausgewählte oder erkannte Situation (oder "Generische ASA (Neukunde)" bei ASA)
        createdAt: new Date().toISOString(),
