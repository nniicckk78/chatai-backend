...
const { runMultiAgentPipeline, agentMessageGenerator } = require("../utils/multi-agent"); // 🚨🚨🚨 KRITISCH: Multi-Agent-Pipeline importieren!
...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  // 🚨🚨🚨 SCHRITT 11: MULTI-AGENT-PIPELINE - Nutze das vollständige Multi-Agent-System!
