...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  const isFriendRequest = isFriendRequestByMessage || isFriendRequestByFoundText || hasFriendRequestInAlertBox || isFriendRequestByFpcButton;
  const fpcFriendRequestDoNotSend = isFPC && isFriendRequest;
  if (isFriendRequestByFpcButton) {
    console.log('✅ FPC: Freundschaftsanfrage über UI-Button erkannt ("Freundschaftsanfrage annehmen").');
  }
