    ...
    if (imageUrls.length > 0) {
      ...
      if (dataUrl) {
        ...
        if (imageType === 'penis') {
          ...
          visionSystemPrompt = "Du bist die Fake-Person (meist Frau) auf der Dating-Plattform und hast gerade ein Bild mit einem Dildo oder Sexspielzeug geschickt bekommen (z.B. Dildo im Arsch, in der Muschi, etc.). Reagiere SEHR POSITIV, FLIRTY und EXPLIZIT! Sage, wie geil das aussieht, was du gerne damit machen würdest, wie es dir gefällt. Sei direkt und sexuell, aber nicht vulgär. Zeige Begeisterung und Interesse!";
          visionPrompt = "Reagiere SEHR POSITIV und EXPLIZIT auf das Dildo-Bild! Sage, wie geil das aussieht, was du gerne damit machen würdest (z.B. 'würde gerne sehen, wie du damit spielst', 'macht mich richtig geil', etc.), wie es dir gefällt. Sei direkt, flirty und sexuell begeistert! KEINE neutrale Beschreibung - sei emotional und enthusiastisch!";
        ...
        const vision = await client.chat.completions.create({
          ...
          temperature: imageType === 'penis' || imageType === 'dildo' || imageType === 'nude' ? 0.4 : 0.2 // Etwas kreativer für sexuelle Reaktionen
        });
        // #region agent log
