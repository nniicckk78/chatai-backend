  ...
  try {
    ...
    if (isLastMessageFromFake) {
      ...
      const hasNegativeNumberSignals = (
        conversationContext.includes("nummer nicht") || 
        conversationContext.includes("keine nummer") || 
        conversationContext.includes("nummer nicht raus") ||
        conversationContext.includes("nummer nicht geben") ||
        conversationContext.includes("nummer nicht weitergeben") ||
        conversationContext.includes("nummer nicht einfach") ||
        conversationContext.includes("nummer nicht so") ||
        conversationContext.includes("nummer ungerne") ||
        conversationContext.includes("nummer ungern") ||
        conversationContext.includes("nummer nicht gerne") ||
        conversationContext.includes("nummer nicht gern") ||
        conversationContext.includes("nummer nicht im internet") ||
        conversationContext.includes("nummer nicht weiter geben") ||
        conversationContext.includes("meine nummer ungerne") ||
        conversationContext.includes("meine nummer ungern") ||
        conversationContext.includes("nummer nicht weitergebe") ||
        conversationContext.includes("nummer nicht weiter gebe")
      );
      
      const hasPositiveNumberSignals = (
        conversationContext.includes("deine nummer") ||
        conversationContext.includes("ihre nummer") ||
        conversationContext.includes("nummer geben") ||
        conversationContext.includes("nummer schicken") ||
        conversationContext.includes("nummer senden") ||
        conversationContext.includes("kannst du mir deine nummer") ||
        conversationContext.includes("kannst du mir ihre nummer")
      );
      ...
      const hasNegativeMeetingSignals = (
        conversationContext.includes("treffen nicht") || 
        conversationContext.includes("kein treffen") ||
        conversationContext.includes("treffen nicht wollen")
      );
      
      const hasPositiveMeetingSignals = (
        conversationContext.includes("treffen wollen") || 
        conversationContext.includes("treffen können") ||
        conversationContext.includes("wollen treffen") ||
        conversationContext.includes("können treffen") ||
        conversationContext.includes("wollen wir uns treffen") ||
        conversationContext.includes("können wir uns treffen")
      );
      ...
      if (trainingData && trainingData.conversations && Array.isArray(trainingData.conversations)) {
        ...
        if (asaTrainingExamples.length > 0) {
          ...
          if (filteredASAExamples.length === 0) {
            ...
            // Falls immer noch keine gefunden, verwende alle (letzter Fallback)
            if (filteredASAExamples.length === 0) {
              console.warn("⚠️ Auch nach Fallback-Filterung keine Beispiele gefunden, verwende alle als letzten Fallback");
