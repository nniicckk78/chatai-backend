...
Antworte NUR mit der neuen Antwort, keine Erklärungen.`;
    ...
    // Flexibler minLength: NIEMALS unter 100 Zeichen! Bei langen Kundennachrichten (200+ Zeichen) auch längere Antworten erwarten
    let minLength;
    if (isNewCustomer) {
      ...
      minLength = 100; // NIEMALS unter 100 Zeichen - auch bei kurzen Nachrichten 100-150 Zeichen
    }
