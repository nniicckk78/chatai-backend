...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  // 🚨 NEU: Bei ASA-Fällen ist Kontext irrelevant - einfach leer lassen
  let conversationContextForPipeline = "";
  try {
    if (isLastMessageFromFake) {
      // 🚨 ASA-FALL: Kontext ist irrelevant, einfach leer lassen
      conversationContextForPipeline = "";
      console.log(`✅ Chat-Kontext für ASA: leer (Kontext wird ignoriert, orientiert sich nur an Training-Daten)`);
    } else {
