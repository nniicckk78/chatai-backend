...
function normalizeLovadoSummary(summary, profileInfo, metaData) {
  ...
  ensureMissing(out.user, "Name", customer.name || customer.firstName || customer.Vorname);
  ...
  ensureMissing(out.assistant, "Name", moderator.name || moderator.firstName || moderator.Vorname);
