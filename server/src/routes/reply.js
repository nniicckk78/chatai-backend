      ...
      if (relevantExamples.length > 0) {
        ...
        try {
          ...
          if (learningStats && Object.keys(learningStats).length > 0) {
            ...
            if (learningContext && learningContext.trim().length > 0) {
              ...
              trainingExamplesContext += `🚨🚨🚨 KRITISCH: Diese Muster wurden aus erfolgreichem Feedback gelernt - nutze sie! 🚨🚨🚨\n\n`;
              trainingExamplesContext += `${learningContext}\n`;
              trainingExamplesContext += `🚨🚨🚨 WICHTIG: Kombiniere Training-Daten + Learning-System Muster für beste Qualität! 🚨🚨🚨\n\n`;
        ...
        relevantExamples.forEach((example, idx) => {
          ...
          if (isPriority) {
            ...
            trainingExamplesContext += `🚨🚨🚨 ANALYSIERE: Welche Wörter werden verwendet? Welcher Ton? Welche Formulierungen? KOPIERE ES! 🚨🚨🚨\n`;
          }
          trainingExamplesContext += `\n`;
        });
