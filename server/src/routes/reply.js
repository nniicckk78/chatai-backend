...
Antworte NUR mit der vollständigen Nachricht inklusive Frage am Ende, keine Erklärungen.`;
    ...
    try {
      ...
      // Fehler im normalen Reply-Pfad abfangen und Fallback-Antwort senden
      ...
      const fallbackReply = "Hey, das klingt interessant. Erzähl mir mehr davon.";
      
      // Verwende finalChatId oder einen stabilen chatId
      let responseChatId = finalChatId || chatId || req.body?.siteInfos?.chatId || "00000000";
