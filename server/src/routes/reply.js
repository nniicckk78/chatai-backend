...
- Übernehme den TON und die FORMULIERUNGEN aus den ASA-Beispielen!\n\n`;
          ...
          const asaExtensionPrompt = `Du erweiterst eine Reaktivierungsnachricht (ASA) auf mindestens 150 Zeichen. Die Nachricht soll natürlich und menschlich klingen, nicht abgehackt.${styleContext}${asaTrainingContext}${asaContextWarning}
