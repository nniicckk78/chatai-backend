...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    // Like/Kuss (ASA): immer alter OpenAI-Pfad (Multi-Stage/Simplified/Multi-Agent), nicht Grok-Pipeline
    if (USE_GROK_PIPELINE && !isASACalculated) {
      // 🚀 Grok-Pipeline: nur normale Reply + Stadtauswahl (ASA/Erstnachricht laufen über alten Pfad)
