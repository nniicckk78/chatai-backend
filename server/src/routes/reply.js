  ...
  if (thankYouTriggerType && !isAVZ) {
    ...
    if (!skipThankYou) {
      const THANK_YOU_INSTRUCTIONS = {
        gruß: "Der Kunde hat dir einen Gruss gesendet. Bedanke dich kurz dafuer, dann stelle 1–2 gespraechsoeffnende Fragen (z.B. wie geht es dir, was machst du, Tag). Keine Selbstvorstellung (kein Name, Alter, Wohnort). Keine Treffen-Anspielungen. Keine sexualisierten Formulierungen. Mindestens 120 Zeichen.",
        kuss: "Der Kunde hat dir einen Kuss geschickt. Bedanke dich kurz dafuer, dann stelle 1–2 gespraechsoeffnende Fragen (z.B. wie geht es dir, was machst du, Tag). Keine Selbstvorstellung. Keine Treffen-Anspielungen. Keine sexualisierten Formulierungen. Mindestens 120 Zeichen.",
        like: "Der Kunde hat dich geliked. Bedanke dich kurz dafuer, dann stelle 1–2 gespraechsoeffnende Fragen (z.B. wie geht es dir, was machst du, Tag). Keine Selbstvorstellung. Keine Treffen-Anspielungen. Keine sexualisierten Formulierungen. Mindestens 120 Zeichen.",
        gefaellt: "Du gefaellst diesem Benutzer (Systemnachricht). Bedanke dich kurz / freue dich kurz, dann stelle 1–2 gespraechsoeffnende Fragen. Keine Selbstvorstellung. Keine Treffen-Anspielungen. Keine sexualisierten Formulierungen. Mindestens 120 Zeichen.",
        favoriten: "Der Kunde hat dich zu seinen/ihren Favoriten hinzugefuegt. Bedanke dich kurz dafuer, dann stelle 1–2 gespraechsoeffnende Fragen. Keine Selbstvorstellung. Keine Treffen-Anspielungen. Keine sexualisierten Formulierungen. Mindestens 120 Zeichen.",
        freundschaftsanfrage: "Der Kunde hat eine Freundschaftsanfrage geschickt. Bedanke dich kurz dafuer, dann stelle 1–2 gespraechsoeffnende Fragen. Keine Selbstvorstellung. Keine Treffen-Anspielungen. Keine sexualisierten Formulierungen. Mindestens 120 Zeichen.",
        befreundet_sein: "Der Kunde moechte mit dir befreundet sein. Bedanke dich kurz / freue dich kurz, dann stelle 1–2 gespraechsoeffnende Fragen. Keine Selbstvorstellung. Keine Treffen-Anspielungen. Keine sexualisierten Formulierungen. Mindestens 120 Zeichen."
      };
