...
- Sei menschlich, emotional, verständnisvoll - nicht mechanisch oder oberflächlich!`;
    ...
    const context = trainingAnalysis ? analyzeContextForValidation(validatedMessage, conversationHistory, extractedUserInfo || {}) : null;
...
Antworte NUR mit der neuen Antwort, keine Erklärungen.`;
          ...
          if (retryText) {
            ...
            if (retryTrainingAnalysis) {
              ...
              const retryContext = analyzeContextForValidation(validatedMessage, retryConversationHistory, extractedUserInfo || {});
