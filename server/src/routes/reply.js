...
const { runMultiAgentPipeline } = require("../utils/multi-agent"); // 🚨🚨🚨 KRITISCH: Multi-Agent-Pipeline importieren!
...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    // Extrahiere generierte Nachricht aus Multi-Agent-Ergebnis
    if (multiAgentResults && multiAgentResults.messageGenerator && multiAgentResults.messageGenerator.message) {
      generatedMessage = multiAgentResults.messageGenerator.message;
      ...
      console.error('❌ Multi-Agent-Pipeline: Keine Nachricht generiert');
      generatedMessage = "";
    }
  } catch (err) {
