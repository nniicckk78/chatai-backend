...
function isKICheckMessage(text) {
  ...
  // 🚨 ZUSÄTZLICH: Erkenne auch wenn "KI-Prüfung" und "Code" in der gleichen Nachricht vorkommen (auch mit Bindestrichen)
  if ((lower.includes("ki") && lower.includes("prüfung")) || (lower.includes("ki") && lower.includes("check"))) {
