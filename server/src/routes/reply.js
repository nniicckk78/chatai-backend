...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    // Vector-DB-Funktion für Multi-Agent-Pipeline – immer aktuelle customerMessage nutzen (verhindert falsche Beispiele bei Chat-Wechsel/Race)
    const vectorDbFunc = async (_query, options = {}) => {
      return await selectSmartExamples(customerMessage, {
