...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  if (!isAVZ && !isFirstMessage && (hasLikeSystemMessage || hasKussSystemMessage || hasGefaelltSystemMessage || hasGrußSystemMessage) && (!foundMessageText || foundMessageText.trim() === "")) {
    console.log("✅ Like/Kuss/Gefällt/Gruß ohne Kundentext – generiere Danke/Freude + Gesprächsstarter (kein ASA).");
    try {
      if (hasGrußSystemMessage) {
