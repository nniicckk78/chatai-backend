    ...
    try {
      ...
      if (hasLikeSystemMessage || hasKussSystemMessage) {
        ...
        const firstMessageInstructions = isKuss
          ? "Der Kunde hat dir einen KUSS geschickt (Kuss-Systemnachricht). NUR: 1) Kurz fuer den Kuss bedanken (NICHT fuer den Like!) – VARIIERE: nicht immer 'Danke fuer deinen Kuss!'; z.B. 'Das freut mich!', 'Oh wie suess!', 'Super dass du dich meldest!', 'Nice, danke!'. 2) 1-2 gespraechsoeffnende Fragen. VERBOTEN: Dich vorstellen (Name, Alter, Wohnort)."
          : isLike
            ? "Der Kunde hat dich GELIKED (Like-Systemnachricht). NUR: 1) Kurz fuer den Like bedanken (NICHT fuer den Kuss!) – VARIIERE: nicht immer 'Danke fuer deinen Like!'; z.B. 'Das freut mich!', 'Oh wie suess!', 'Super dass du dich meldest!', 'Nice, danke!'. 2) 1-2 gespraechsoeffnende Fragen. VERBOTEN: Dich vorstellen (Name, Alter, Wohnort)."
            : "Der Kunde hat dir einen Kuss oder Like geschickt (System-Nachricht). NUR: Danke (Formulierung variieren – nicht immer woertlich 'Danke fuer deinen Kuss/Like!') + 1-2 gespraechsoeffnende Fragen. VERBOTEN: Dich vorstellen (kein Name, kein Alter, kein Wohnort).";
