...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  // 🚨 FIX: Zu alte System-Trigger (Kuss/Like/Gefällt/Favoriten/Gruß/Freundschaft) dürfen NICHT mehr als Auslöser dienen.
  // Sonst reagiert das System auf sehr alte Systembubbles (z.B. S69 "Kuss Nachricht!💋" von vor Stunden).
  try {
    ...
    if (newestSystemTriggerMsg && tsRaw) {
      ...
      if (!isNaN(tms) && tms > 0) {
        ...
        if (ageMs > maxSystemTriggerAgeMs) {
