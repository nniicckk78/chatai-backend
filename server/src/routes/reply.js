    ...
    if (!skipThankYou) {
      ...
      if (instructions) {
        ...
        return res.status(200).json({
          ...
          flags: { blocked: false, thankYouTriggerType, isFriendRequest: thankYouTriggerType === 'freundschaftsanfrage', isBefreundetSein: thankYouTriggerType === 'befreundet_sein', noReload: true, skipReload: true, preventReload: true, ...(isFPC ? { reloadPageAfterSend: true } : {}), ...(isFPC && thankYouTriggerType === 'freundschaftsanfrage' ? { fpcFriendRequestDoNotSend: true } : {}) },
