...
TELEFONNUMMER/KONTAKTDATEN: Wenn der Kunde eine Telefonnummer oder Kontaktdaten mitteilt, die von der Plattform zensiert sind (z.B. als *** oder ***** angezeigt), trage unter Other NICHT die zensierte Form ein. Schreibe stattdessen genau: "Telefonnummer bekannt" (bzw. "E-Mail bekannt" oder "Kontaktdaten bekannt", falls zensierte E-Mail/Adresse).
...
{
  "Name": "Name/Kosename falls die Person sich so bezeichnet, sonst null",
  ...
  "Other": "Sonstige Infos über die Person (Termine wie 'morgen Zahnarzt', 'heute was mit Freundin', Vorlieben, etc.), sonst null"
}
...
- \"Sport and Hobbies\": NUR echte Sportarten/Hobbys. KEINE Essensvorlieben (z.B. \"mag es würzig\", \"scharf\", \"Knoblauch\", \"Gewürze\", \"mag wenn es würzig ist\") – solche Infos weglassen oder unter Other, nie unter Sport and Hobbies.
  ...
  if (client && generatedMessage && generatedMessage.trim() !== "") {
    try {
      ...
      if (assistantFromReply && typeof assistantFromReply === "object" && Object.keys(assistantFromReply).length > 0) {
        ...
        if (profileModName) extractedInfo.assistant["Name"] = profileModName;
