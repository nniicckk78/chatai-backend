...
// Helper: Timeout-Wrapper, damit Requests nicht "still" hängen bleiben (wichtig für Extension-Kommunikation)
...
Nachricht: ${messageText}`;
    ...
    const extraction = await withTimeout(extractionPromise, 15000, "extractInfoFromMessage");
...
Antworte NUR mit der neuen Antwort, keine Erklärungen.`;
          ...
          const retryChat = await withTimeout(
            client.chat.completions.create({
              model: "gpt-4o-mini",
              messages: [
