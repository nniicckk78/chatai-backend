...
- Nachrichtenlänge: 100-150 Zeichen sind ideal - nicht zu kurz, aber auch nicht unnötig lang!
...
Antworte NUR mit der neuen Antwort, keine Erklärungen.`;
    ...
    // 🚨 KRITISCH: Prüfe Mindestlänge - NEUKUNDEN brauchen 150 Zeichen!
    const minLength = isNewCustomer ? 150 : 80;
...
Antworte NUR mit der erweiterten Version (mindestens 150 Zeichen), keine Erklärungen.`
        : `Die folgende Antwort ist zu kurz. Erweitere sie auf mindestens 80 Zeichen, füge eine Frage am Ende hinzu und mache sie natürlicher:
        ...
        const extended = await client.chat.completions.create({
          ...
          messages: [
            { role: "system", content: isNewCustomer 
              ...
              : "Du erweiterst Nachrichten auf mindestens 80 Zeichen und fügst eine Frage hinzu." },
