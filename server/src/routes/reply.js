        ...
        try {
          ...
          if (response.data && response.data.content) {
            ...
            const defaultSituations = {
              ...
              "Verabschiedung / Aufgeben": "Der Kunde verabschiedet sich endgueltig oder gibt auf (nicht nur kurz schlafen/arbeiten). Lass ihn NICHT einfach gehen: Reagiere freundlich und einladend, signalisiere dass du ihn nicht so schnell aufgeben willst. Beruhige ggf. und stelle eine passende Frage, die ihn einlaedt zu bleiben – nicht mit Danke/dir auch verabschieden. Formuliere variabel und natürlich, keine feste Phrase."
            };
    ...
    if (fs.existsSync(rulesPath)) {
      ...
      if (!parsed || (Object.keys(parsed).length === 0 && !parsed.forbiddenWords && !parsed.preferredWords && !parsed.generalRules && !parsed.situationalResponses)) {
        ...
        const defaultSituations = {
          ...
          "Verabschiedung / Aufgeben": "Der Kunde verabschiedet sich endgueltig oder gibt auf (nicht nur kurz schlafen/arbeiten). Lass ihn NICHT einfach gehen: Reagiere freundlich und einladend, signalisiere dass du ihn nicht so schnell aufgeben willst. Beruhige ggf. und stelle eine passende Frage, die ihn einlaedt zu bleiben – nicht mit Danke/dir auch verabschieden. Formuliere variabel und natürlich."
        };
