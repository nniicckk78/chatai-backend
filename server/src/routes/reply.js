      ...
      if (trainingData && trainingData.asaExamples && Array.isArray(trainingData.asaExamples) && trainingData.asaExamples.length > 0) {
        ...
        let filteredGenericASAs = trainingData.asaExamples.filter(example => {
          ...
          if (typeof example === 'string') {
            ...
            response = example.moderatorResponse || example.text || example.message || example.response || example.asa || "";
          }
        ...
        if (filteredGenericASAs.length > 0) {
          ...
          if (typeof randomGenericASA === 'string') {
            ...
            asaMessage = randomGenericASA.moderatorResponse || randomGenericASA.text || randomGenericASA.message || randomGenericASA.response || randomGenericASA.asa || "";
            console.log(`🔍 DEBUG: Objekt-Felder: moderatorResponse=${!!randomGenericASA.moderatorResponse}, text=${!!randomGenericASA.text}, message=${!!randomGenericASA.message}, response=${!!randomGenericASA.response}, asa=${!!randomGenericASA.asa}`);
          } else {
            asaMessage = "";
          }
