...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  if ((!foundMessageText || foundMessageText.trim() === "") && req.body?.siteInfos?.messages) {
    ...
    // 🚨 KRITISCH: Kundentext NICHT überschreiben! Wenn foundMessageText bereits substanziellen Kundentext hat (>30 Zeichen), behalte ihn – Bild ist dann Zusatz.
    ...
    if (req.body?.siteInfos?.messages && !hasSubstantialCustomerText) {
