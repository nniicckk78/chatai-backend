...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  /** FPC, Cherry, Gold/S69: Extension nutzt 3s Post-Typing-Timer (content.js); JSON delay/waitTime hier angleichen für Logs/Konsistenz. */
  const useFastInsertSendDelay = isFPC || isCherryReply || isModsGoldChatsxForTrigger;
  function insertSendDelaySecForPlatform() {
    if (useFastInsertSendDelay) return 3;
    const minW = 40;
    const maxW = 60;
