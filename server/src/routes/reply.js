...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  // 🚨 NEU: Erweitere System-Prompt mit ausgewählten Beispielen
  const systemPrompt = (baseSystemPrompt || "Du bist ein Chat-Moderator auf einer Dating-Plattform.") + examplesPrompt;
  ...
  try {
    const response = await client.chat.completions.create({
      ...
      temperature: isASACalculated ? 0.8 : 0.7, // Höhere Temperatur für ASA-Variation
      max_tokens: 500
    });
