...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  // 🤖 SCHRITT 11: FINE-TUNING GENERIERUNG - Einfache Nachrichtengenerierung mit Fine-Tuned Model
  ...
  if (isASACalculated) {
    ...
    // Extrahiere Situation (vereinfacht)
  ...
  // Generiere Nachricht mit Fine-Tuned Model
  ...
  try {
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: systemPrompt || "Du bist ein Chat-Moderator auf einer Dating-Plattform."
        },
        {
          role: "user",
          content: userContent
  ...
  try {
    ...
    const feedbackPayload = {
      ...
      platform: platformId || 'viluu',
      isASA: isASACalculated || false,
      usedExampleIds: [], // Fine-Tuning verwendet keine Beispiel-IDs mehr
      context: {
        detectedSituations: [],
        mood: 'neutral',
        style: 'neutral',
