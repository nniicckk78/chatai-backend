...
router.post("/", asyncHandler(async (req, res, next) => {
  ...
  if (isFirstMessage && !isAVZ) {
    ...
    try {
      ...
      if (hasLikeSystemMessage || hasKussSystemMessage || hasGefaelltSystemMessage || hasFavoritenSystemMessage || hasGrußSystemMessage) {
        const isKuss = hasKussSystemMessage && !hasLikeSystemMessage && !hasGefaelltSystemMessage && !hasFavoritenSystemMessage && !hasGrußSystemMessage;
        const isGruß = hasGrußSystemMessage;
  ...
  const triggerGrußResponse = hasGrußSystemMessage || hasGrußFromAsa;
  if (!isAVZ && !isFirstMessage && (hasLikeSystemMessage || hasKussSystemMessage || hasGefaelltSystemMessage || hasGrußSystemMessage || hasGrußFromAsa) && noRealCustomerText) {
