...
const EXTRA_RULES = {
  ...
  keinNaechstesMalSehen: 'NIEMALS GETROFFEN: Kunde und Fake haben sich NIE getroffen. VERBOTEN: "wiedersehen"/"wiederzusehen", "nächstes Mal sehen", "wenn wir uns das nächste Mal sehen", "beim nächsten Mal" im Treffen-Kontext; ausserdem "dich endlich sehen", "dich endlich zu sehen", "in deinen Armen (sein)", "dich in die Arme nehmen", "freue mich dich endlich zu sehen" – nichts, was ein reales Treffen oder koerperliche Begegnung andeutet. Stattdessen: "wenn wir uns (mal) sehen", "wenn wir uns treffen", "wenn es so weit ist", Vorfreude nur im Chat (z.B. "freue mich wenn du schreibst"), ohne "wieder"/"nächstes Mal"/"endlich sehen"/"in deinen Armen".\n',
...
async function runMistralCorrector({ customerMessage = '', context = {}, grokText = '', learningContext = '', exampleSnippet = '', planSnippet = '', conversationSnippet = '' }) {
  ...
  const noWiedersehenRule = ' PFLICHT: Enthaelt die Antwort "wiedersehen", "wiederzusehen", "mal wieder treffen", "wenn wir uns wiedersehen" ODER "nächstes Mal sehen", "wenn wir uns das nächste Mal sehen", "beim nächsten Mal" (im Treffen-Kontext) ODER "dich endlich sehen", "dich endlich zu sehen", "in deinen Armen", "in deinen Armen sein", "dich in die Arme nehmen", "freue mich dich endlich zu sehen"? Ihr habt euch NIE getroffen – nichts andeuten, was ein reales Treffen oder koerperliche Begegnung voraussetzt. Wenn ja → ersetzen durch "wenn wir uns (mal) sehen", "wenn wir uns treffen", "wenn es so weit ist", "was wir zusammen machen könnten" bzw. Vorfreude nur im Chat (z.B. "freue mich wenn du schreibst", "bin gern hier fuer dich") – ohne "wieder", "nächstes Mal", "endlich sehen", "in deinen Armen".';
...
async function runOpenAIFullCorrector({ customerMessage = '', context = {}, grokText = '', learningContext = '', exampleSnippet = '', planSnippet = '', conversationSnippet = '' }) {
  ...
  const noStrongHopeRule = ' Starke Vorfreude oder Formulierung wie feste Treffen-Zusage (z.B. "freue mich schon auf unser Treffen")? → zurueckhaltender und unverbindlicher umformulieren, wunschhaft/hypothetisch, variieren.';
  const noWiedersehenRule = ' PFLICHT: "wiedersehen", "wiederzusehen", "wenn wir uns wiedersehen" ODER "nächstes Mal sehen", "wenn wir uns das nächste Mal sehen", "beim nächsten Mal" (Treffen-Kontext) ODER "dich endlich sehen", "dich endlich zu sehen", "in deinen Armen", "dich in die Arme nehmen", "freue mich dich endlich zu sehen" → ersetzen durch "wenn wir uns (mal) sehen", "wenn wir uns treffen", "wenn es so weit ist" bzw. Vorfreude nur im Chat (z.B. "freue mich wenn du schreibst"); ihr habt euch NIE getroffen, keine Formulierung fuer reales Treffen/koerperliche Begegnung.';
