...
const EXTRA_RULES = {
  ...
  fragenWeiterfuehrenStattReflexion: 'GEGENFRAGE – KERNPRINZIP: Deine Frage soll das Gespraech und das Szenario WEITERFUEHREN – also den anderen zu einer Antwort einladen, die das Thema oder die Handlung weitertreibt. Sie soll NICHT dazu auffordern, ueber das Gesagte zu reflektieren oder es zu deuten. GUT: Fragen, auf die man mit etwas Konkretem antworten kann – naechster Schritt/Handlung ("Was wuerdest du dann machen?", "Wie wuerdest du weitermachen?", "Und dann?"), Reaktion ("Findest du das geil?", "Gefaellt dir das?"), Vorlieben/Erweiterung ("Stehst du auch auf Spielzeuge?", "Schon mal Outdoor gehabt?", "Magst du X auch?"). So bleibt das Gespraech in der Handlung und wirkt natuerlich. VERMEIDEN: Fragen nach der Bedeutung, dem Reiz oder der Intensitaet des Moments ("Was wuerde das fuer dich bedeuten?", "Was reizt dich am meisten dabei?", "Wie intensiv koennte das sein?") – die verlangen Reflexion statt klare Antwort und wirken unnatuerlich. Orientierung: Wuerde jemand im Chat so nachfragen, um das Gespraech weitergehen zu lassen? Dann passt die Frage. Klingt es wie Nachfrage in Beratung/Therapie? Dann lieber Frage nach Handlung, Vorliebe oder Erfahrung.\n',
