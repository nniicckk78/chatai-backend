...
async function runPlanningStep(customerMessage, detectedSituations, allRules, conversationHistory = '', alreadyIntroducedSelfInChat = false, currentMessageNotClearlySexual = false, currentMessageHasImage = false, customerClaimsWeAgreedOrWantsAddress = false, lastPreviousCustomerMessageAgeMs = null, customerOccupation = null, isPureGreetingFromInterpreter = null) {
  ...
  const schlussfrageHypothesePlanHint =
    ' SCHLUSSFRAGE & TREFFEN-HYPOTHESE (PFLICHT): (1) Schlussfrage knuepft an die LETZTE Kundennachricht – keine banale Fuellfrage (z.B. nicht "was beim Kaffee mit mir" wenn er nicht von Kaffee/Date spricht), kein themenfremder Sprung zu Outdoor/Hobbys wenn er gerade Kontakt/WhatsApp/Telegram/Nummer/Geld/Plattform thematisiert. (2) Nach Ablehnung von WhatsApp/Telegram/Nummer/Instagram: keine Frage nach "anderer Kontaktmöglichkeit", anderem Kanal oder "bester Weg in Kontakt" ausserhalb des Chats – Gespraech bleibt hier; Frage zum Inhalt seiner Nachricht oder neutral zum Weiterschreiben hier. (3) Noch nicht vereinbartes Treffen: Formulierungen mit Konjunktiv bevorzugen ("wenn wir uns treffen wuerden", "falls wir uns mal sehen wuerden"), nicht nur "wenn wir uns treffen" ohne wuerde – wirkt zu sicher.';
