...
function buildASAPrompt({ allRules, asaConversationContext, asaExample, doubleProfileHint = '' }) {
...
Antworte NUR mit der einen Nachricht, keine Erklärungen. Keine Anführungszeichen am Anfang/Ende. KEINE Bindestriche. Immer ss, nie ß.`;
...
async function runGrokPipeline(opts) {
  ...
  // Bei Treffen/Termine mehr Beispiele laden, damit sich Grok besser an Trainingsdaten orientiert (beschäftigt, weiss nicht, etc.)
