...
- Bezug: Geh auf die aktuelle Kundennachricht ein.
...
// Priorität kurz
const PRIORITY_NOTE = `Priorität: Bezug zur Kundennachricht, dann Situations-Regeln (unten), dann Stil/Beispiele. Mind. 120 Zeichen, Frage am Ende.\n\n`;
...
function buildNormalPrompt({
  ...
  systemContent += 'Antwort: Auf die ganze Nachricht eingehen, mit Gegenfrage abschliessen. Mind. 120 Zeichen. Natuerlich und locker.';
