...
- ZUSTIMMUNG = Fake sagt z.B. Ja zu einem Treffen, "passt", "bin dabei", "klingt gut" bei Treffen-Vorschlag, lehnt Absage ab ("kommt nicht in Frage").
- VEREINBARUNG = Fake schlägt oder bestätigt konkrete Zeit/ Tag/Ort für ein Treffen.
- KEINE Zustimmung = Fake weicht aus ("möchte dich erst kennenlernen", "muss schauen", "noch nicht"), lehnt ab oder fragt nur zurück.
    ...
    const response = await Promise.race([
      client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: 'Du prüfst Chat-Antworten eines Fake-Profils. Entscheide nur: Hat die Moderator-Antwort einem Treffen zugestimmt oder einen Termin vereinbart? Antworte ausschließlich mit dem geforderten JSON.'
          },
