...
async function runOpenAIFullCorrector({ customerMessage = '', context = {}, grokText = '', learningContext = '', exampleSnippet = '', planSnippet = '', conversationSnippet = '' }) {
  ...
  const noGenericOpenAIPhrasesRuleOpenAI = ' FLOSKEL-EINSTIEG/GENERISCHER TON: Beginnt die Antwort mit "Das klingt spannend", "Klingt spannend", "Das klingt gut", "Klingt gut" oder anderen formelhaften Floskeln ("klingt echt spannend", "ich stell mir vor wie wir uns näherkommen", "du mich richtig verwöhnst")? Wenn ja → Einstieg entfernen/ersetzen: direkt auf die Kundennachricht eingehen, keine Floskeln am Anfang.';
