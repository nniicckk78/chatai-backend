...
function buildNormalPrompt({
  ...
  if (examples && examples.length > 0) {
    userContent += 'TRAININGS-BEISPIELE – Stil und Ton daran orientieren; Inhalt richtet sich nach der Kundennachricht und dem Plan. Bei erkannter Situation (z.B. Geld/Coins) bestimmt die Situations-Regel den Inhalt, Beispiele nur für Ton/Länge. Antwort mit Gegenfrage wie in den Beispielen:\n';
