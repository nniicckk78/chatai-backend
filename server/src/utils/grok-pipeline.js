...
- DOPPELDEUTIGKEIT: Ist der Kontext bereits sexuell/flirty (Vorlieben, Sex, Fantasie, Koerper, explizite Themen)? Dann doppeldeutige Formulierungen (z. B. "Das wuerde mir schmecken", "vernaschen", "Nachtisch", "etwas Leckeres" auf die Person bezogen) in diesem Sinne verstehen und wiedergeben – nicht auf harmloses Essen reduzieren (z. B. "dich vernaschen/dich als Nachtisch" statt "etwas Leckeres essen").
- NICHT SEXUALISIEREN OHNE KONTEXT: Enthaelt die Nachricht ein klares nicht-sexuelles Angebot (Kaffee, Kuchen, Besuch, E-Bike) OHNE sexuelle Formulierung und OHNE sexuellen Kontext? Gib die Bedeutung GENAU SO wieder – interpretiere es nicht als sexuell.
