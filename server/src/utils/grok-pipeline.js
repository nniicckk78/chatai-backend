...
Rechtschreibung: Schreibe die Nachricht in normaler deutscher Rechtschreibung mit ä, ö, ü (Umlaute) – z.B. wäre, möchte, für, schön, nicht waere oder moechte. Immer ss, nie ß. Keine Anführungszeichen am Anfang/Ende. KEINE Bindestriche.
...
async function runGrokPipeline(opts) {
  ...
  // Bei Treffen/Termine oder Kontaktdaten mehr Beispiele laden (streng an Trainingsdaten: ablehnen, freundlich, Frage am Ende)
  const exampleTopK = (primarySituation === 'Treffen/Termine' || primarySituation === 'Kontaktdaten außerhalb der Plattform') ? 5 : 3;
  let examples = [];
