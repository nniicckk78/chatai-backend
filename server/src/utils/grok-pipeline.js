...
async function runGrokPipeline(opts) {
  ...
  const fakeHasWohnortAlready = fakeCity && !isBundesland(fakeCity);
  if (!suggestsLocation) {
    locationContext = null;
