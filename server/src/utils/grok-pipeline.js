...
async function ensureQuestionInMessage(message, opts = {}) {
  ...
  const systemRules = [
    ...
    'Die Frage soll das GESPRÄCH WEITERFUEHREN – also handlungsnah, konkret, auf die letzte Aussage bezogen (z.B. naechster Schritt, "Und dann?", "Gefaellt dir das?", "Magst du X?", Vorliebe/Detail). NICHT reflexiv oder meta.',
    'VERBOTEN: Reflexionsfragen wie "Was reizt dich (am meisten/dabei/daran)?", "Was denkst du dazu/darueber?", "Was ist dir dabei am wichtigsten?", "Was magst du am liebsten dabei?", "Was gefaellt dir dabei am meisten?", "Was ist dir dabei wichtig?", "Wie intensiv koennte das sein?" – nie einbauen. Nur konkrete, szenische Fragen (naechster Schritt, Tempo, Reihenfolge, Reaktion), auf die man mit Handlung/Vorliebe/Ja-Nein antworten kann.',
