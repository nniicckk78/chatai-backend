...
// Priorität kurz
const PRIORITY_NOTE = `Priorität: Zuerst auf den Inhalt der Kundennachricht eingehen (Frage, Thema, genannte Details), dann Situations-Regeln (unten), dann Stil/Beispiele. Mind. 120 Zeichen, Frage am Ende.\n\n`;
...
function buildNormalPrompt({
  ...
  if (examples && examples.length > 0) {
    userContent += 'TRAININGS-BEISPIELE – Orientiere dich am Stil und Ton dieser Beispiele, Inhalt zur Situation anpassen. Antwort mit Gegenfrage wie in den Beispielen:\n';
  ...
  userContent += 'Ausgabe: Genau eine Nachricht (nur der Text, keine Erklaerungen, keine woertliche Wiederholung der Kundennachricht; mit Frage am Ende).';
