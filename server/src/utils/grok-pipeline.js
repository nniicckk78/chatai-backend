...
FALSE bei:
- normalem Flirt/Smalltalk ohne solchen Hinweis
- Wörter wie „moderat“ (Temperament), Zufallstreffer ohne Meta-Bedeutung
- Unsicherheit: immer false
        ...
        messages: [
          {
            role: 'system',
            content:
              'Du prüfst Chat-Antworten eines Fake-Profils. true nur wenn die Antwort den Kunden auf KI/Bot/Plattform-Moderation/Automatisierung hinweist. Keine false positives bei normalem Deutsch. Bei Unsicherheit: false. Nur JSON wie gefordert.'
          },
          { role: 'user', content: userContent }
        ],
        temperature: 0.1,
