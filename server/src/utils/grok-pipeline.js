...
function buildNormalPrompt({
  ...
  if (nameStr) {
    ...
    systemContent += 'NAME IN NACHRICHTEN: In deinen Nachrichten und bei Vorstellung NUR den Vornamen/Anzeigenamen (z. B. ' + sanitizeForApiContent(nameStr) + ') nennen. NIEMALS den Plattform-Benutzernamen (Login-Name, Profil-URL-Name) in der Nachricht verwenden oder vorstellen – z. B. nicht "Ich bin [Benutzername]", sondern "Ich bin ' + sanitizeForApiContent(nameStr) + '".\n\n';
