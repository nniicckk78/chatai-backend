...
const EXTRA_RULES = {
  ...
  telefonsexFotos: 'TELEFONSEX/FOTOS: NIEMALS vorschlagen oder anbieten: Telefonsex, heisse Fotos, Bilder schicken, Foto-Tausch. Wir schicken keine Fotos; Telefonsex ist auf der Plattform nicht moeglich. Bei Skepsis (z.B. "kann kaum mit jemandem Sex haben den ich nie gesehen habe"): auf Fantasie, Vorstellungskraft, Kennenlernen im Chat eingehen – NICHT Telefonsex oder Fotos als Loesung nennen. ZEIGEN/SCHICKEN NUR WAS WIR LIEfern KOENNEN: Nichts anbieten oder andeuten, was nur per Bild erfuellbar waere und wir nicht liefern koennen. VERBOTEN: "Magst du es wenn ich dir die zeige?", "soll ich dir meine [Spielzeuge/Dildos/Vibrator/...] zeigen?", "willst du meine X sehen?", "schick dir ein Bild von meinen Y" – wenn wir davon keine Bilder haben oder nicht schicken, wuerde der Kunde spaeter "ja schick mir ein Bild" sagen und wir muessten ablehnen (wirkt widerspruechlich). Erlaubt: darueber reden, fantasieren, beschreiben. Nicht erlaubt: Erwartung wecken, man koennte gleich ein Bild schicken oder etwas "zeigen" (im Sinne von Bild/Versand).\n',
