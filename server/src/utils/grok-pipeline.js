...
async function runMistralCorrector({ customerMessage = '', context = {}, grokText = '', learningContext = '', exampleSnippet = '', planSnippet = '', conversationSnippet = '' }) {
  ...
  const replyMustAddressCurrentMessageRule = ' AKTUELLE NACHRICHT IGNORIERT: Enthaelt die AKTUELLE (letzte) Kundennachricht ein klares anderes Thema oder einen anderen Ton (z.B. explizit, erste Nacht, lecken, Szenario, "dich auspacken", "richtig knallen", "wenn du dich traust", emotionale Bindung/Fantasie wie "dich um den Verstand bringen") – und die zu korrigierende Antwort geht stattdessen auf ein frueheres Thema ein (z.B. "unsicher", "Vertrauen braucht Zeit", Karriere/Beruf, Fotos, etwas das er vor mehreren Nachrichten erwaehnt hat)? Wenn ja → Antwort umschreiben: primaer auf DIESE aktuelle Kundennachricht eingehen (auf das was er JETZT geschrieben hat), nicht auf ein frueheres Thema. Ton und Thema der Antwort muessen zur aktuellen Nachricht passen.';
...
async function runOpenAIFullCorrector({ customerMessage = '', context = {}, grokText = '', learningContext = '', exampleSnippet = '', planSnippet = '', conversationSnippet = '' }) {
  ...
  const replyMustAddressCurrentMessageRuleOpenAI = ' AKTUELLE NACHRICHT IGNORIERT: Enthaelt die AKTUELLE (letzte) Kundennachricht ein klares anderes Thema oder einen anderen Ton (z.B. explizit, erste Nacht, lecken, Szenario, "dich auspacken", "richtig knallen", "wenn du dich traust", emotionale Bindung/Fantasie wie "dich um den Verstand bringen") – und die zu korrigierende Antwort geht stattdessen auf ein frueheres Thema ein (z.B. "unsicher", "Vertrauen braucht Zeit", Karriere/Beruf, Fotos, etwas das er vor mehreren Nachrichten erwaehnt hat)? Wenn ja → Antwort umschreiben: primaer auf DIESE aktuelle Kundennachricht eingehen (auf das was er JETZT geschrieben hat), nicht auf ein frueheres Thema. Ton und Thema der Antwort muessen zur aktuellen Nachricht passen.';
