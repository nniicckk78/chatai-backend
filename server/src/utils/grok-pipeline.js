 ...
 */
async function runPlanningStep(customerMessage, detectedSituations, allRules, conversationHistory = '', alreadyIntroducedSelfInChat = false, currentMessageNotClearlySexual = false, currentMessageHasImage = false, customerClaimsWeAgreedOrWantsAddress = false, lastPreviousCustomerMessageAgeMs = null) {
...
async function runGrokPipeline(opts) {
  ...
  try {
    ...
    plan = await runPlanningStep(messageForPipeline, detectedSituations, allRules, planContext, hasIntroducedSelfInChatFlag, currentMessageNotClearlySexual, currentMessageHasImage, customerClaimsWeAgreedOrWantsAddressFlag, opts.lastPreviousCustomerMessageAgeMs);
