...
async function correctAndImproveMessage({ customerMessage = '', context = {}, grokText = '' }) {
  ...
  const systemContent = `Du bist ein Korrektor für Chat-Moderator-Antworten. ${contextRule} ${sexualRule} Korrigiere nur echte Verstöße. Verbessere Stil und Klarheit, klare Frage am Ende. Was bereits gut ist, unverändert lassen. Antworte NUR mit der korrigierten/verbesserten Nachricht. Keine Anführungszeichen. Immer ss, nie ß. Keine Bindestriche.`;
