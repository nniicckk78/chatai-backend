...
${isASA ? '\n🚨🚨🚨 KRITISCH: DIES IST EINE REAKTIVIERUNGSNACHRICHT (ASA)! 🚨🚨🚨\n- Der Kunde hat zuletzt nicht geantwortet.\n- Reaktiviere das Gespräch freundlich und interessiert.\n- Frage, was den Kunden beschäftigt.\n- Sei warmherzig, aber nicht aufdringlich.\n' : ''}`;
    ...
    if (rules.preferredWordsContext) {
      ...
      // Wenn Mood "traurig" oder "frustriert" → Filtere sexuelle bevorzugte Wörter
      if (mood.mood === 'traurig' || mood.mood === 'frustriert') {
        ...
        console.log(`⚠️ Sexuelle bevorzugte Wörter gefiltert (Mood: ${mood.mood})`);
      }
    ...
    if (message) {
      ...
      // Wenn keine eigenen Erfahrungen/Interessen genannt wurden, ergänze sie
      if (!proactiveCheck || !proactiveCheck.hasOwnExperience) {
        ...
        // Kontextabhängige proaktive Ergänzungen
        ...
        if (hasSexualContent) {
          ...
          // Allgemeine proaktive Ergänzungen
        ...
        console.log(`✅ Proaktive Ergänzung hinzugefügt: "${proactiveAddition.trim()}"`);
      }
