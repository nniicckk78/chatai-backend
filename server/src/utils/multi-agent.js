...
const ASA_STRONG_CONTEXT_MAX_HOURS = 3;
const ASA_SOFT_CONTEXT_MIN_HOURS = 4;
const ASA_SOFT_CONTEXT_MAX_HOURS = 15;
...
async function runMultiStagePipeline({
  ...
  if (isASA) {
    ...
    if (hasCustomerInLast10 && ageHours != null && ageMinutes >= ASA_CONTEXT_MIN_MINUTES && ageHours <= ASA_SOFT_CONTEXT_MAX_HOURS && ageHours < ASA_POOL_FROM_HOURS) {
      ...
      } else if (ageHours >= ASA_SOFT_CONTEXT_MIN_HOURS) {
