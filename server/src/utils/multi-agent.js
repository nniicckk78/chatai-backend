...
async function runMultiAgentPipeline({
  ...
  const [situationResult, fakeContextResult] = await Promise.all([
    runAgentWithFallback(
      ...
      15000,
      customerMessage, allRules, isLocationQuestionFunc, findNearbyCityFunc, isMeetingRequestFunc, profileInfo, extractedUserInfo, conversationHistory, moderatorMessages, customerMessages, contextResult, false, learningContextResult
    ),
