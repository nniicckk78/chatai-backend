...
5. KONTEXT-VERBINDUNGEN: Wie bezieht sich die Kunden-Nachricht auf die letzte Moderator-Nachricht?
...
Antworte NUR als JSON im Format:
{
  ...
  "lastModeratorMessageTheme": "Was war das THEMA der letzten Moderator-Nachricht? (z.B. 'in die Augen schauen', 'Wahrheit erfahren', 'mysteriös/geheimnisvoll')",
  "customerResponseType": "Wie reagiert der Kunde? ('spielerisch', 'neugierig', 'referenziert Thema', 'fragt nach Ankündigung')",
  "contextConnections": [
    {
      ...
      "theme": "Was war das THEMA der letzten Moderator-Nachricht? (z.B. 'in die Augen schauen')",
      "action": "Was der Moderator jetzt tun muss (z.B. 'erzählen', 'beantworten', 'erfüllen', 'spielerisch darauf eingehen', 'Thema aufgreifen')"
    }
  ],
  "criticalInstructions": "Kurze, prägnante Anweisungen für den Moderator (max. 300 Zeichen). BEISPIEL: Wenn letzte Moderator-Nachricht 'Was verbergen deine Augen?' war und Kunde antwortet 'Das musst du herausfinden', dann: 'Reagiere spielerisch auf das Thema \"in die Augen schauen\". Beispiel: \"Da hast du recht, das muss ich machen. Was genau würde mich erwarten, wenn ich dir ganz tief in die Augen schauen würde?\"'"
}
...
Antworte NUR als JSON, kein zusätzlicher Text.`;
    ...
    if (lastModeratorMessageTheme || customerResponseType === 'spielerisch' || customerResponseType === 'neugierig' || customerResponseType === 'referenziert Thema') {
