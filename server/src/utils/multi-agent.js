      ...
      try {
        ...
        if (learningDataForScoring) {
          ...
          if (processedVariants.length > 0) {
            ...
            // 🚨 VERBESSERT: Hard-Filter für semantische Validierung
            // Wenn semanticValidation Score < 80% (von 25% = 20%), filtere diese Variante raus
            // Semantische Validierung ist kritisch - wenn die Nachricht nicht zum Kontext passt, ist sie unbrauchbar!
            const semanticThreshold = 20; // 80% von 25% (stärkerer Filter)
