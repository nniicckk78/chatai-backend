...
WICHTIG – NIE wegen eines einzelnen Wortes oder kurzer Phrase als Fremdsprache werten:
- Ein einzelnes fremdsprachiges oder eingedeutschtes Wort in ansonsten deutscher Nachricht = DEUTSCH (z.B. Minijob, Job, okay, cool, Team, Chat, Date, Story, Like, Check, Feedback, Meeting, Kiss, Love, Baby, Hey, Hi, Sorry, Thanks, etc.)
- Kurze englische Gruess- oder Abschlussformeln in ansonsten deutscher Nachricht (z.B. "Kiss Lina", "Kiss", "Love", "Hey" am Ende) = DEUTSCH. Die Nachricht ist dann weiterhin DEUTSCH.
- Deutsch mit Rechtschreibfehlern = DEUTSCH
- Deutsch in Umgangssprache = DEUTSCH
- Deutsch mit Emojis = DEUTSCH
- Nur wenn die Nachricht hauptsaechlich in einer anderen Sprache ist (mehrere Saetze oder der Grossteil der Woerter, z.B. Serbisch, Kroatisch, vollstaendig Englisch, Tuerkisch) = NICHT DEUTSCH
...
Antworte NUR als JSON, kein zusätzlicher Text.`;
    ...
    // Nur bei hoher Sicherheit als "nicht deutsch" werten – kurze englische Phrasen (z.B. "Kiss Lina") in sonst deutscher Nachricht nicht blockieren
    if (!isGerman && confidence > 0.85) {
