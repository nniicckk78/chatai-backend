...
async function runMultiStagePipeline({
  ...
  if (isASA) {
    ...
    // Kontext-ASA: Kunde in letzten 10 Nachrichten + Alter < 23 h (kein unteres Zeitfenster mehr – auch 0min nutzt Kontext, z. B. Blenny)
    const canUseContext = hasCustomerInLast10 && (ageHours == null || ageHours < ASA_POOL_FROM_HOURS);
    if (canUseContext) {
