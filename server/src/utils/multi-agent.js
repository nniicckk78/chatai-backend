...
Antworte NUR als JSON, kein zusätzlicher Text.`;
    ...
    const hasLikelyGerman = hasGermanChars || germanWordPattern.test(msg) || (msg.length >= 8 && /\b(und|ist|nicht|mit|der|die|das|auf|nur|grad|fkk|was|von|dich|dir|will|geil)\b/i.test(msg));
