...
- Mindestlänge: 120 Zeichen - stelle sicher, dass die Nachricht lang genug ist!
...
${isASA ? '\n🚨🚨🚨 KRITISCH: DIES IST EINE REAKTIVIERUNGSNACHRICHT (ASA)! 🚨🚨🚨\n- Der Kunde hat zuletzt nicht geantwortet.\n- Reaktiviere das Gespräch freundlich und interessiert.\n- Frage, was den Kunden beschäftigt.\n- Sei warmherzig, aber nicht aufdringlich.\n' : ''}`;
    ...
    if (message) {
      ...
      // 🚨 KRITISCH: ALLE Nachrichten müssen mindestens 120 Zeichen lang sein!
      const minLength = 120;
      if (message.length < minLength) {
        console.warn(`⚠️ Nachricht zu kurz (${message.length} Zeichen, benötigt >=${minLength}) - erweitere...`);
