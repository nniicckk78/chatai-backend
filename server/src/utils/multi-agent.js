...
${isASA ? '\n🚨🚨🚨 KRITISCH: DIES IST EINE REAKTIVIERUNGSNACHRICHT (ASA)! 🚨🚨🚨\n- Der Kunde hat zuletzt nicht geantwortet.\n- Reaktiviere das Gespräch freundlich und interessiert.\n- Frage, was den Kunden beschäftigt.\n- Sei warmherzig, aber nicht aufdringlich.\n' : ''}`;
    ...
    // 18. Kunden-Nachricht
    // 🚨 ASA-FALL: Kontext ist irrelevant - einfach ASA-Anweisungen geben
    if (isASA) {
      ...
      userPrompt += `- Reaktiviere das Gespräch freundlich und interessiert (wie in Training-Daten)\n`;
      userPrompt += `- Stelle eine natürliche Frage (wie in Training-Daten)\n\n`;
    } else {
