...
Beispiele: Wenn das letzte Thema Sex war → auf das Gespräch Bezug nehmen und frech einladen. Wenn der Kunde sagte, er geht arbeiten → "Hoffe bei der Arbeit läuft alles gut, denkst du auch an mich?"
...
Antworte NUR mit der einen Nachricht, nichts anderes.`;
  ...
  const userContent = `Letzte Nachrichten im Chat (Kunde / Fake):\n${conversationSnippet}\n\nSchreibe die Reaktivierungsnachricht (mind. ${ASA_MIN_LENGTH} Zeichen):`;
