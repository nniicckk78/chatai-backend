        ...
        loadTrainingDataForVectorDb().then(trainingData => {
          ...
          (async () => {
            try {
              ...
              // 🚨 NEU: Deep Learning Patterns beim ersten Start einmalig extrahieren (blockierend)
              try {
                ...
                if (!hasDeepPatterns) {
                  console.log('🧠🧠🧠 Deep Patterns nicht vorhanden - starte EINMALIGE Extraktion beim Start...');
                  ...
                  if (result) {
                    console.log('✅ Deep Patterns erfolgreich beim Start extrahiert - Agent kann jetzt verwendet werden');
                  }
                } else {
                  console.log('✅ Deep Patterns bereits vorhanden - Agent kann verwendet werden');
                }
              } catch (err) {
                console.warn('⚠️ Deep Pattern Extraction beim Start fehlgeschlagen (nicht kritisch):', err.message);
                console.warn('   Patterns werden im Hintergrund extrahiert...');
              }
            } catch (err) {
